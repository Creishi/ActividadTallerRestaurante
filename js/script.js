...
const defaultPedidos = [
    ...
    { id: 1016, cliente: "Miguel Torres", tipo: "domicilio", mesa: null, items: [{ id: 3, name: "Croquetas de Jamón", price: 95, quantity: 2 }, { id: 9, name: "Limonada Natural", price: 45, quantity: 1 }], total: 235, estado: "completado", fecha: getDateOffset(0) },
    { id: 1017, cliente: "Gustavo Medina", tipo: "mesa", mesa: "4", items: [{ id: 7, name: "Pollo al Horno", price: 195, quantity: 1 }, { id: 2, name: "Bowl de Hummus", price: 79, quantity: 1 }, { id: 10, name: "Café Latte", price: 55, quantity: 1 }], total: 329, estado: "pendiente", fecha: getDateOffset(0) },
    { id: 1018, cliente: "Daniela Rojas", tipo: "domicilio", mesa: null, items: [{ id: 16, name: "Paella Valenciana", price: 225, quantity: 1 }, { id: 13, name: "Brownie de Chocolate", price: 75, quantity: 2 }], total: 375, estado: "completado", fecha: getDateOffset(-1) },
    { id: 1019, cliente: "Oscar Guerrero", tipo: "mesa", mesa: "2", items: [{ id: 4, name: "Ribeye Steak", price: 285, quantity: 1 }, { id: 11, name: "Smoothie de Fruits", price: 65, quantity: 1 }, { id: 12, name: "Tiramisú Clásico", price: 85, quantity: 1 }], total: 435, estado: "completado", fecha: getDateOffset(-1) },
    { id: 1020, cliente: "Sandra Navarro", tipo: "mesa", mesa: "5", items: [{ id: 6, name: "Pasta Carbonara", price: 175, quantity: 1 }, { id: 1, name: "Bruschetta Italiana", price: 89, quantity: 1 }], total: 264, estado: "pendiente", fecha: getDateOffset(-2) },
    { id: 1021, cliente: "Arturo Herrera", tipo: "domicilio", mesa: null, items: [{ id: 8, name: "Burger Gourmet", price: 165, quantity: 2 }, { id: 15, name: "Churros con Chocolate", price: 69, quantity: 1 }], total: 399, estado: "completado", fecha: getDateOffset(-2) },
